...
export default function Header({ fivemValid, onOpenSettings, onOpenModsFolder, onRefresh, refreshing }: HeaderProps) {
  return (
    <header className="header">
      ...
      <div className="header-right">
        ...
        <button className="action-btn" onClick={onOpenModsFolder} title="فتح مجلد الجرافكس">📁 Add File</button>
